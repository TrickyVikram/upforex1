  ...
  ngOnInit(): void {
    ...
    const schema = {
      ...
      '@graph': [
        ...
        {
          '@type': 'WebPage',
          '@id': 'https://www.upforex.com/forex-trading-cape-town#webpage',
          url: 'https://www.upforex.com/forex-trading-cape-town',
          name: 'Forex Trading in Cape Town, South Africa | UPFOREX MT5 Access',
          description:
          ...
          about: {
            '@id': 'https://www.upforex.com/forex-trading-cape-town#service',
          },
          breadcrumb: {
            '@id': 'https://www.upforex.com/forex-trading-cape-town#breadcrumb',
          },
          primaryImageOfPage: {
            '@type': 'ImageObject',
        ...
        },
        {
          ...
          itemListElement: [
            ...
            },
            {
              '@type': 'ListItem',
              position: 3,
              name: 'Forex Trading in Cape Town',
            },
          ],
        },
        {
          '@type': 'Service',
          '@id': 'https://www.upforex.com/forex-trading-cape-town#service',
          name: 'Forex Trading in Cape Town, South Africa',
        ...
        {
          '@type': 'FAQPage',
          '@id': 'https://www.upforex.com/forex-trading-cape-town#faq',
          mainEntity: [
            {
              '@type': 'Question',
              name: 'Can I open a forex trading account from Cape Town?',
              acceptedAnswer: {
                '@type': 'Answer',
                text: "South Africa isn't named in UPFOREX's published restricted-region list. Access depends on              identity checks, local law and the serving entity.",
              },
            },
            {
              '@type': 'Question',
              name: 'How do beginners start forex trading in South Africa?',
              acceptedAnswer: {
                '@type': 'Answer',
                text: "Learn how leverage and margin work, check the broker's status and compare total account costs.              A demo account lets you practise using MT5 before considering a live account.",
              },
            },
            {
              '@type': 'Question',
              ...
              acceptedAnswer: {
                '@type': 'Answer',
                text: 'The published minimum is $100 for Standard, $1,000 for Pro-ECN and $5,000 for Elite-ECN. All              three accounts are listed in USD, so ZAR conversion costs can apply.',
              },
            },
            {
              '@type': 'Question',
              ...
              acceptedAnswer: {
                '@type': 'Answer',
                text: "UPFOREX's public account table doesn't directly confirm a ZAR-denominated account or a South              African EFT funding option. Check with support about payment methods, exchange rates, deposit fees and  withdrawal rules before sending funds.",
              },
            },
          ],
        },
    ...
    const existing = this.document.getElementById('cape-town-schema');
    if (existing) existing.remove();
    const script = this.document.createElement('script');
    script.id = 'cape-town-schema';
